...
MODEL_PATH = os.getenv('MODEL_PATH', "/Users/sawetr/.lmstudio/models/lmstudio-community/gemma-3-27B-it-qat-GGUF/gemma-3-27B-it-QAT-Q4_0.gguf")
MMPROJ_PATH = os.getenv('MMPROJ_PATH', "/Users/sawetr/.lmstudio/models/lmstudio-community/gemma-3-27B-it-qat-GGUF/mmproj-model-f16.gguf")
...
# Model settings based on model type
...
def generate_metadata(image_path):
    ...
    try:
        ...
        The metadata must be in a valid JSON format and include: "author", "date" (in YYYY-MM-DD format), "Title" (create one if you can't find any), a one-sentence "summary", and the "document_type".
        ...
        # Add system info
        metadata["_model_used"] = "gemma" if "gemma" in MODEL_PATH.lower() else "qwen"
        metadata["_timestamp"] = str(datetime.now())
        ...
        return {
            ...
            "_model_used": "gemma" if "gemma" in MODEL_PATH.lower() else "qwen",
